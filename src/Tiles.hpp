...
#define TILE_PLAYER_CONTROLLING TILE_FACE_SOLID
#define TILE_PLAYER_NOTCONTROLLING TILE_FACE_OUTLINE
#define TILE_PLAYER_DEAD TILE_HEART
#define TILE_DOOR_SHUT 8 //197
#define TILE_DOOR_OPEN 7
#define TILE_DOORREQUIRESKEY_SHUT 10
#define TILE_DOORREQUIRESKEY_OPEN 9
#define TILE_WINDOW 240
#define TILE_LEVER_OFF 149
#define TILE_LEVER_ON 162
#define TILE_TERMINAL 146
#define TILE_TIMEMACHINE 143//157
#define TILE_TIMEMACHINE_ACTIVE_1 TILE_TIMEMACHINE
#define TILE_TIMEMACHINE_ACTIVE_2 142
#define TILE_RADIATION_WEAK TILE_FADE_LIGHT
#define TILE_RADIATION_STRONG TILE_FADE_MIDDLE
#define TILE_PRESSUREPLATE_UP TILE_RECTANGLE
#define TILE_PRESSUREPLATE_DOWN TILE_UNDERSCORE
#define TILE_MOTIONALARM 241
#define TILE_MOTIONALARM_ACTIVE_1 242
#define TILE_MOTIONALARM_ACTIVE_2 243

#define STATE_DOOR_SHUT false
#define STATE_DOOR_OPEN true
#define STATE_LEVER_OFF false
#define STATE_LEVER_ON true
#define STATE_PRESSUREPLATE_UP false
#define STATE_PRESSUREPLATE_DOWN true
#define STATE_MOTIONALARM_INACTIVE false
#define STATE_MOTIONALARM_ACTIVE true
